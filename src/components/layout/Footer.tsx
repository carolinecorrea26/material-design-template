    ...
    <Box component="footer" sx={commonStyles.footer}>
      <Container>
        <Box sx={{ 
          ...
          <Box>
            <Stack spacing={1}>
              <Typography variant="subtitle1" sx={{ fontWeight: 600, mb: 1, color: 'white', fontSize: '0.875rem' }}>
                Administered By:
              </Typography>
              <Typography variant="body2" sx={{ color: 'rgba(255, 255, 255, 0.7)', fontSize: '0.75rem' }}>
                American Bar Endowment<br />
                321 North Clark Street<br />
                14th Floor<br />
              ...
              <Box sx={{ mt: 2 }}>
                <Typography variant="body2" sx={{ color: 'rgba(255, 255, 255, 0.7)', fontSize: '0.75rem' }}>
                  ...
                  <Link href="http://abendowment.org" target="_blank" rel="noopener noreferrer" sx={{ color: 'rgba(255, 255, 255, 0.9)', fontSize: '0.75rem' }}>
                    abendowment.org
                  </Link>
                </Typography>
                <Typography variant="body2" sx={{ color: 'rgba(255, 255, 255, 0.7)', fontSize: '0.75rem' }}>
                  <strong>Phone:</strong>{" "}
                  <Link href="tel:8006218981" sx={{ color: 'rgba(255, 255, 255, 0.9)', fontSize: '0.75rem' }}>
                    (800) 621-8981
                  </Link>
                </Typography>
                <Typography variant="body2" sx={{ color: 'rgba(255, 255, 255, 0.7)', fontSize: '0.75rem' }}>
                  <strong>Email:</strong>{" "}
                  <Link href="mailto:information@abendowment.org" sx={{ color: 'rgba(255, 255, 255, 0.9)', fontSize: '0.75rem' }}>
          ...
          <Box>
            <Stack spacing={1}>
              ...
              <Box sx={{ mt: 2 }}>
                <Typography variant="body2" sx={{ color: 'rgba(255, 255, 255, 0.7)', fontSize: '0.75rem' }}>
                  <Link 
                    ...
                    sx={{ cursor: 'pointer', color: 'rgba(255, 255, 255, 0.9)', fontSize: '0.75rem' }}
                  >
                    NYL Terms of Use
                  </Link>
                  {" · "}
              ...
              <Box sx={{ mt: 2, display: 'flex', gap: 3, alignItems: 'flex-start' }}>
                ...
                {/* Ratings */}
                <Box>
                  <Typography variant="body2" sx={{ color: 'rgba(255, 255, 255, 0.7)', fontSize: '0.75rem', lineHeight: 1.6 }}>
                    <Box component="span" sx={{ fontWeight: 700, fontSize: '0.875rem' }}>A++</Box> A.M. Best<br />
                    <Box component="span" sx={{ fontWeight: 700, fontSize: '0.875rem' }}>AAA</Box> Fitch Ratings<br />
                    <Box component="span" sx={{ fontWeight: 700, fontSize: '0.875rem' }}>Aa1</Box> Moody's Investors Service<br />
                    <Box component="span" sx={{ fontWeight: 700, fontSize: '0.875rem' }}>AA+</Box> Standard & Poor's
                  </Typography>
                  <Typography variant="caption" sx={{ color: 'rgba(255, 255, 255, 0.5)', display: 'block', mt: 1, fontSize: '0.625rem' }}>
