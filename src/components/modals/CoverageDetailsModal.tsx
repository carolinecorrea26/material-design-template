...
export function CoverageDetailsContent({
  coverageInfoCards,
  productAmounts,
  categoryAmounts,
}: Omit<CoverageDetailsModalProps, "open" | "onClose" | "title">) {
  return coverageInfoCards.length > 0 ? (
    <Stack spacing={2}>
      {coverageInfoCards.map((card) => (
        ...
        >
          ...
          >
            ...
            <Typography variant="body2" sx={commonStyles.coverageCategoryLabel}>
              ...
              return (
                <Accordion
                  ...
                  sx={{
                    ...
                    bgcolor: "#ffffff",
                    "&:before": { display: "none" },
                    borderBottom: index === card.products.length - 1 ? 0 : 1,
                    borderColor: "divider",
                  }}
                >
                        ...
                        <Stack spacing={0.5}>
                          {product.applicants.map((applicant) => {
                            const defaultAmount =
                              ...
                              productMeta?.coverageHighlight ??
                              "Varies by product";
                            const amountByApplicant: Record<string, string> = {
                              Self: defaultAmount,
                            ...
                            return (
                              ...
                              >
                                ...
                                {applicantLabelMap[applicant] ?? applicant}:{" "}
                                {amountByApplicant[applicant] ?? defaultAmount}
                              </Typography>
                            );
                          })}
                        </Stack>
