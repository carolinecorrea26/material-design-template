...
export const coverages: CoverageDefinition[] = [
  ...
  },
  {
    ...
    categoryId: "LI",
    name: "50+ Life",
    definition: "Provides life coverage designed for eligible applicants age 50 and over.",
  ...
  },
  {
    ...
    definition: "Provides coverage for accidental death or certain accidental injuries.",
    applicants: ["member", "spouse", "child"],
    underwritingType: "NA",
    options: [{ id: "amount", type: "amount", choices: [] }],
  },
  {
    ...
    categoryId: "LI",
    name: "Preferred Life",
    definition: "Provides life coverage with product terms specific to the preferred offering.",
    applicants: ["member", "spouse"],
    underwritingType: "FUW",
    options: [{ id: "amount", type: "amount", choices: [] }],
  },
  {
    ...
    definition: "Provides accident coverage with benefits for covered accidental injuries.",
    applicants: ["member", "spouse", "child"],
    underwritingType: "NA",
    options: [{ id: "amount", type: "amount", choices: [] }],
  },
  ...
  },
  {
    ...
    definition: "Provides disability income protection for a mid-term benefit period.",
    applicants: ["member"],
    underwritingType: "FUW",
    options: [
      { id: "amount", type: "amount", choices: [] },
  ...
  },
  {
    ...
    definition: "Provides disability income protection with step-rated premium structure.",
    applicants: ["member"],
    underwritingType: "FUW",
    options: [
      { id: "amount", type: "amount", choices: [] },
  ...
  },
  {
    ...
    definition: "Provides disability income protection with level premium structure.",
    applicants: ["member"],
    underwritingType: "FUW",
    options: [
      { id: "amount", type: "amount", choices: [] },
  ...
  },
  {
    ...
    definition: "Helps cover eligible office overhead expenses if the insured becomes disabled.",
    applicants: ["member"],
    underwritingType: "FUW",
    options: [
      { id: "amount", type: "amount", choices: [] },
