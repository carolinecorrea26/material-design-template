...
export const pages = [
  ...
  },
  {
    ...
    path: "/eligibility",
    type: "form",
    title: "See if you're eligible and view your coverage options.",
    groupId: "get-started",
  },
  {
    id: "coverage",
    path: "/coverage",
    type: "form",
    title: "Choose the coverage you want to apply for.",
    groupId: "coverage",
  },
  {
    ...
    type: "form",
    title: "Answer a few questions based on your selections.",
    groupId: "coverage",
  },
  {
    id: "coverage-options",
    ...
    type: "form",
    title: "Customize your selected coverage options.",
    groupId: "coverage",
  },
  {
    id: "beneficiary",
    path: "/beneficiary",
    type: "form",
    title: "Choose who you'd like as your beneficiaries.",
    groupId: "coverage",
  },
  {
    id: "contact",
  ...
  },
  {
    ...
    path: "/personal",
    type: "form",
    title: "We just need a few more details about you to keep going.",
    groupId: "profile",
  },
  {
    id: "financial",
    path: "/financial",
    type: "form",
    title: "We need some information about any existing coverage.",
    groupId: "profile",
  },
  {
    id: "review",
