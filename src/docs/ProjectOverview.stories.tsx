...
const siteRules: {
  ...
  { area: "Application flow", rule: "Client page mode = none", behavior: "If Beneficiary or Payment is configured as none, the page is skipped from the active form flow.", ref: "src/config/flowGates.ts; getClientPageRequirement" },
  { area: "Application flow", rule: "Beneficiary routing", behavior: "Beneficiary is shown only when selected coverage includes Life (LI) or Accidental Death (AD), unless the page is configured as none.", ref: "src/config/flowGates.ts" },
  { area: "Application flow", rule: "Health SI routing", behavior: "Health SI is shown when at least one selected product uses SI underwriting.", ref: "src/config/flowGates.ts" },
  { area: "Application flow", rule: "Health LI routing", behavior: "Health LI is shown when selected Life coverage uses TELE underwriting.", ref: "src/config/flowGates.ts" },
  { area: "Application flow", rule: "Health QD routing", behavior: "Health QD is shown when at least one selected product uses QD underwriting.", ref: "src/config/flowGates.ts" },
  { area: "Application flow", rule: "Health DI routing", behavior: "Health DI is shown when selected Disability coverage uses TELE underwriting.", ref: "src/config/flowGates.ts" },
  { area: "Application flow", rule: "Health CIR routing", behavior: "Health CIR is shown when the canonical CIR rider gate is satisfied.", ref: "src/config/flowGates.ts" },
  ...
  { area: "Landing Page", rule: "Variant behavior", behavior: "default = quote entry card with drawer continuation; quoteFirst = complete progressive quote inline above supporting content; hero-image = hero image, no quote tool; welcome-back = hero image, Continue/New Application actions, and hides How Applying Works and Coverage Options.", ref: "src/pages/Home.tsx" },
