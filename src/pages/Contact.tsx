...
import { 
  Stack, Typography, Alert, Box, Checkbox, FormControlLabel, Card, CardContent
} from "@mui/material";
...
import { Person, People, ContactMail, Email } from '@mui/icons-material';
    ...
    <FormProvider {...methods}>
      <form onSubmit={methods.handleSubmit(onSubmit)} noValidate>
        <Stack spacing={2}>
          ...
          <Card sx={commonStyles.categoryCard}>
            <CardContent>
              <Stack spacing={2}>
                ...
                <Alert severity="info">
                  A representative of New York Life or their medical service provider may contact you to collect your health history and, if necessary, schedule any medical exam that may be needed at no cost to you and at a time and place convenient to you. Your prompt responses will help speed up the processing of your application. <strong>Learn more about medical underwriting.</strong>
                </Alert>
          ...
          <PageNavigation hasUnsavedChanges={() => methods.formState.isDirty} />
        </Stack>
      </form>
    </FormProvider>
  );
