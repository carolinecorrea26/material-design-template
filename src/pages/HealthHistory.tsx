...
export default function HealthHistory() {
  ...
  const methods = useForm<HealthHistoryForm>({
    ...
    defaultValues: data.healthHistory || {
      question1Details: {
        onsetDate: "",
        conditionDetails: "",
        physicianInfo: "",
    ...
    const handleFillForm = () => {
      const filledData: Partial<HealthHistoryForm> = {
        ...
        question6Details: {
          ...
          conditionDetails:
            "Diagnosed with hypertension, currently managing with medication",
        ...
        question12Details: {
          ...
          conditionDetails:
            "Elevated cholesterol, controlled with diet and medication",
                  ...
                  <Stack spacing={2}>
                    ...
                    <Stack spacing={3}>
                      {healthQuestions.map((q) => {
                        const questionKey =
                          `question${q.id}` as keyof HealthHistoryForm;
                        const detailsKey =
                          `question${q.id}Details` as keyof HealthHistoryForm;
                                ...
                                {answer === "yes" && (
                                  ...
                                  >
                                    <Stack spacing={3}>
                                      ...
                                      <Box>
                                        <FormLabel required>
                                          Condition/Medication & Details
                                          (Medical Advice Given, Treatment,
                                          Results, Date Recovered)
                                        </FormLabel>
                                        <RHFTextField
