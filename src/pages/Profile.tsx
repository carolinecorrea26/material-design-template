                ...
                <CardContent>
                  <Stack spacing={2}>
                    ...
                    <Alert severity="info">
                      ...
                      details about your privacy and safety in the privacy
                      notice.
                    </Alert>
                            ...
                            <Stack spacing={3}>
                              ...
                              <Box sx={{ mt: 4 }}>
                                ...
                                <Typography
                                  ...
                                  sx={{ mb: 2 }}
                                >
                                  Providing your spouse's physician's details
                                  will speed up processing your application by
                                  allowing us to confirm any health information,
                                  if needed.
                                </Typography>
                      ...
                      <CardContent>
                        <Stack spacing={2}>
                          ...
                          <Stack spacing={3}>
                            ...
                            <Box>
                              <FormLabel required>
                                Total net worth (Liquid Assets minus
                                Liabilities)
                              </FormLabel>
                              <RHFCurrencyField
                                name="totalNetWorth"
                                ...
                                {methods.watch("isSoleProprietor") && (
                                  ...
                                  >
                                    ...
                                    <Stack spacing={2}>
                                      ...
                                      <Box>
                                        <FormLabel required>
                                          Gross earnings before business
                                          expenses and taxes
                                        </FormLabel>
                                        <RHFCurrencyField
                                      ...
                                      <Box>
                                        <FormLabel required>
                                          Total business expenses for above
                                          period (your share)
                                        </FormLabel>
                                        <RHFCurrencyField
                                    ...
                                    <Stack spacing={2}>
                                      ...
                                      <Box>
                                        <FormLabel required>
                                          ...
                                          (e.g. Life or Health Insurance
                                          premiums, pension or profit sharing
                                          trust contributions paid on your
                                          behalf)
                                        </FormLabel>
                                        <RHFCurrencyField
            ...
            <Card sx={commonStyles.categoryCard}>
              <CardContent>
                <Stack spacing={2}>
                  ...
                  <Alert severity="info">
                    A beneficiary can be a person or a trust. If naming more
                    than one person as beneficiary, the percentage of death
                    proceeds to be distributed to each must total 100%. If
                    naming a trust as beneficiary, 100% of proceeds will be paid
                    to the trust. A primary beneficiary is a designated
                    individual who would receive the proceeds of the policy
                    first. A contingent beneficiary is a designated individual
                    who would receive the proceeds of the policy if the primary
                    beneficiary is unable to receive them. You may add up to ten
                    primary and ten contingent beneficiaries online. If no
                    beneficiary is named, proceeds will be paid in accord with
                    policy provisions. If you wish to add beneficiary
                    information at a later time, or need to add more, please
                    contact the plan administrator at (800) 621-8981. Note: The
                    beneficiary for dependent Child(ren) coverage is the Member.
                  </Alert>
                            ...
                            <Stack spacing={2}>
                              ...
                              <Stack spacing={3}>
                                ...
                                <Box>
                                  ...
                                  <Alert severity="info" sx={{ mb: 2 }}>
                                    I make the following beneficiary designation
                                    with respect to all life insurance under
                                    this insurance plan and, if I am already
                                    covered under the plan, I hereby revoke any
