...
export default function Profile() {
  ...
  React.useEffect(() => {
    const autosaveEnabled =
      sessionStorage.getItem("nyl-autosave-enabled") === "1";
    if (autosaveEnabled) {
  ...
  const wantsToBeneficiaries = useWatch({
    control: methods.control,
    name: "wantsToBeneficiaries",
  });
  const termLifeBeneficiaryType = useWatch({
    control: methods.control,
    name: "termLifeBeneficiaryType",
  });
  const tenYearTermBeneficiaryType = useWatch({
    control: methods.control,
    name: "tenYearTermBeneficiaryType",
  });
  const twentyYearTermBeneficiaryType = useWatch({
    control: methods.control,
    name: "twentyYearTermBeneficiaryType",
  });
  const addBeneficiaryType = useWatch({
    control: methods.control,
    name: "addBeneficiaryType",
  });

  // Watch for spouse beneficiary conditional fields
  const spouseTermLifeBeneficiaryType = useWatch({
    control: methods.control,
    name: "spouseTermLifeBeneficiaryType",
  });
  const spouseTenYearTermBeneficiaryType = useWatch({
    control: methods.control,
    name: "spouseTenYearTermBeneficiaryType",
  });
  const spouseTwentyYearTermBeneficiaryType = useWatch({
    control: methods.control,
    name: "spouseTwentyYearTermBeneficiaryType",
  });
  const spouseAddBeneficiaryType = useWatch({
    control: methods.control,
    name: "spouseAddBeneficiaryType",
  });

  // Watch for payment conditional fields
  const wantsToAddPayment = useWatch({
    control: methods.control,
    name: "wantsToAddPayment",
  });
  const termLifePaymentMethod = useWatch({
    control: methods.control,
    name: "termLifePaymentMethod",
  });
  const tenYearTermPaymentMethod = useWatch({
    control: methods.control,
    name: "tenYearTermPaymentMethod",
  });
  const twentyYearTermPaymentMethod = useWatch({
    control: methods.control,
    name: "twentyYearTermPaymentMethod",
  });
  const addPaymentMethod = useWatch({
    control: methods.control,
    name: "addPaymentMethod",
  });
  const longTermDisabilityPaymentMethod = useWatch({
    control: methods.control,
    name: "longTermDisabilityPaymentMethod",
  });
  const midTermDisabilityPaymentMethod = useWatch({
    control: methods.control,
    name: "midTermDisabilityPaymentMethod",
  });
  const professionalOverheadPaymentMethod = useWatch({
    control: methods.control,
    name: "professionalOverheadPaymentMethod",
  });
  const criticalIllnessPaymentMethod = useWatch({
    control: methods.control,
    name: "criticalIllnessPaymentMethod",
  });
  const hospitalMoneyPaymentMethod = useWatch({
    control: methods.control,
    name: "hospitalMoneyPaymentMethod",
  });

  // Watch for payment frequency fields
  const termLifePaymentFrequency = useWatch({
    control: methods.control,
    name: "termLifePaymentFrequency",
  });
  const tenYearTermPaymentFrequency = useWatch({
    control: methods.control,
    name: "tenYearTermPaymentFrequency",
  });
  const twentyYearTermPaymentFrequency = useWatch({
    control: methods.control,
    name: "twentyYearTermPaymentFrequency",
  });
  const addPaymentFrequency = useWatch({
    control: methods.control,
    name: "addPaymentFrequency",
  });
  const longTermDisabilityPaymentFrequency = useWatch({
    control: methods.control,
    name: "longTermDisabilityPaymentFrequency",
  });
  const midTermDisabilityPaymentFrequency = useWatch({
    control: methods.control,
    name: "midTermDisabilityPaymentFrequency",
  });
  const professionalOverheadPaymentFrequency = useWatch({
    control: methods.control,
    name: "professionalOverheadPaymentFrequency",
  });
  const criticalIllnessPaymentFrequency = useWatch({
    control: methods.control,
    name: "criticalIllnessPaymentFrequency",
  });
  const hospitalMoneyPaymentFrequency = useWatch({
    control: methods.control,
  ...
  const getSelectedApplicants = (productId: string): string[] => {
    const selectedItems = coverageData.filter(
  ...
  const calculateTotalCost = (
    ...
    const costMap: Record<string, Record<string, Record<string, number>>> = {
      "li-term": {
        ...
        quarterly: { Self: 13.91, Spouse: 8.5, "Child(ren)": 2.25 },
        semiannually: { Self: 27.82, Spouse: 17.0, "Child(ren)": 4.5 },
        annually: { Self: 55.64, Spouse: 34.0, "Child(ren)": 9.0 },
      },
      "li-10yr": {
        monthly: { Self: 1.82, Spouse: 1.25, "Child(ren)": 0.75 },
        quarterly: { Self: 5.46, Spouse: 3.75, "Child(ren)": 2.25 },
        semiannually: { Self: 10.92, Spouse: 7.5, "Child(ren)": 4.5 },
        annually: { Self: 21.84, Spouse: 15.0, "Child(ren)": 9.0 },
      },
  ...
  const renderEstimatedCostSection = (
    productId: string,
  ...
  React.useEffect(() => {
    const handleFillForm = () => {
      const filledData = {
        ...
        spouseMedicalFacilityName: spouseSelected
          ? "Metro Health Center"
          : undefined,
        ...
        spouseDisabilityCompanies: spouseSelected
          ...
          : undefined,
        spouseDisabilityReplacement: spouseSelected
          ? ("no" as const)
          : undefined,
        ...
        spouseTermLifeBeneficiaryType: spouseSelected
          ? ("individual" as const)
          : undefined,
        spouseTermLifeBeneficiaryDesignation: spouseSelected
          ? ("primary" as const)
          : undefined,
        ...
        spouseTermLifeBeneficiaryRelationship: spouseSelected
          ? "spouse"
          : undefined,
        spouseTermLifeBeneficiaryShare: spouseSelected ? "100" : undefined,
        spouseTenYearTermBeneficiaryType: spouseSelected
          ? ("individual" as const)
          : undefined,
        spouseTenYearTermBeneficiaryDesignation: spouseSelected
          ? ("primary" as const)
          : undefined,
        spouseTenYearTermBeneficiaryFirstName: spouseSelected
          ? "John"
          : undefined,
        spouseTenYearTermBeneficiaryLastName: spouseSelected
          ? "Doe"
          : undefined,
        spouseTenYearTermBeneficiaryRelationship: spouseSelected
          ? "spouse"
          : undefined,
        spouseTenYearTermBeneficiaryShare: spouseSelected ? "100" : undefined,
        spouseTwentyYearTermBeneficiaryType: spouseSelected
          ? ("individual" as const)
          : undefined,
        spouseTwentyYearTermBeneficiaryDesignation: spouseSelected
          ? ("primary" as const)
          : undefined,
        spouseTwentyYearTermBeneficiaryFirstName: spouseSelected
          ? "John"
          : undefined,
        spouseTwentyYearTermBeneficiaryLastName: spouseSelected
          ? "Doe"
          : undefined,
        spouseTwentyYearTermBeneficiaryRelationship: spouseSelected
          ? "spouse"
          : undefined,
        spouseTwentyYearTermBeneficiaryShare: spouseSelected
          ? "100"
          : undefined,
        spouseAddBeneficiaryType: spouseSelected
          ? ("individual" as const)
          : undefined,
        spouseAddBeneficiaryDesignation: spouseSelected
          ? ("primary" as const)
          : undefined,
            ...
            <Card sx={commonStyles.categoryCard}>
              <CardContent>
                <Stack spacing={2}>
                  ...
                  <Alert severity="info">
                    We make sure your information is secure. You may find more
                    details about your privacy and safety in the privacy notice.
                  </Alert>
                        ...
                        <Stack spacing={2}>
                          ...
                          <Box sx={{ mt: 4 }}>
                            ...
                            <Typography
                              ...
                              sx={{ mb: 2 }}
                            >
                              Providing your physician's details will speed up
                              processing your application by allowing us to
                              confirm any health information, if needed.
                            </Typography>
                          ...
                          <Stack spacing={3}>
                            ...
                            <Box sx={{ mt: 4 }}>
                              ...
                              <Typography
                                ...
                                sx={{ mb: 2 }}
                              >
                                Providing your spouse's physician's details will
                                speed up processing your application by allowing
                                us to confirm any health information, if needed.
                              </Typography>
                    ...
                    <CardContent>
                      <Stack spacing={2}>
                        ...
                        <Stack spacing={3}>
                          ...
                          <Box>
                            <FormLabel required>
                              Total annual unearned income (As reported to IRS –
                              e.g. Interest, Dividends, Royalties, Rental Income
                              etc.)
                            </FormLabel>
                            <RHFCurrencyField
                              ...
                              {methods.watch("isSoleProprietor") && (
                                ...
                                >
                                  ...
                                  <Stack spacing={2}>
                                    <Box>
                                      <FormLabel required>
                                        Gross earned income (share of
                                        partnership income) Past 12 months or
                                        fiscal year ending
                                      </FormLabel>
                                      <RHFCurrencyField
                                    ...
                                    <Box>
                                      <FormLabel required>
                                        Total business expenses for above period
                                        (your share)
                                      </FormLabel>
                                      <RHFCurrencyField
                                    ...
                                    <Box>
                                      <Typography
                                        ...
                                        sx={{ fontWeight: 600, mb: 1 }}
                                      >
                                        Net earned income, before personal
                                        income tax:*
                                      </Typography>
                                      <Typography variant="h6" color="primary">
                                        ...
                                        {(() => {
                                          ...
                                          const businessExpenses = parseFloat(
                                            methods.watch(
                                              "soleProprietorBusinessExpenses",
                                            ) || "0",
                                          );
                                          return Math.max(
                                            0,
                                            grossEarnings - businessExpenses,
                                          ).toFixed(2);
                                        })()}
                                      </Typography>
                                    </Box>
                              ...
                              {methods.watch("isProfessionalCorp") && (
                                ...
                                >
                                  ...
                                  <Stack spacing={2}>
                                    ...
                                    <Box>
                                      <FormLabel required>
                                        Your share of S-Corp distribution, if
                                        any
                                      </FormLabel>
                                      <RHFCurrencyField
                                    ...
                                    <Box>
                                      <FormLabel required>
                                        Annual Cost of corporate-paid benefits
                                        (e.g. Life or Health Insurance premiums,
                                ...
                                <Stack spacing={2}>
                                  ...
                                  {methods.watch("isWorkingFromHome") ===
                                    ...
                                    <>
                                      ...
                                      <Box>
                                        <FormLabel required>
                                          Please explain and/or provide details
                                          including average number of days per
                                          week clients are seen
                                        </FormLabel>
                                        <RHFTextField
                              ...
                              {methods.watch("hasDisabilityInsurance") ===
                                ...
                                <>
                                  <Alert severity="info">
                                    ...
                                    benefit amount, benefit period, and waiting
                                    period below.
                                  </Alert>
                                  ...
                                  <Button
                                    ...
                                    onClick={() => {
                                      ...
                                      methods.setValue("disabilityCompanies", [
                                        ...currentCompanies,
                                        {
                                          company: "",
                                          monthlyBenefit: "",
          ...
          <Card sx={commonStyles.categoryCard}>
            <CardContent>
              <Stack spacing={2}>
                ...
                <Alert severity="info">
                  A beneficiary can be a person or a trust. If naming more than
                  one person as beneficiary, the percentage of death proceeds to
                  be distributed to each must total 100%. If naming a trust as
                  beneficiary, 100% of proceeds will be paid to the trust. A
                  primary beneficiary is a designated individual who would
                  receive the proceeds of the policy first. A contingent
                  beneficiary is a designated individual who would receive the
                  proceeds of the policy if the primary beneficiary is unable to
                  receive them. You may add up to ten primary and ten contingent
                  beneficiaries online. If no beneficiary is named, proceeds
                  will be paid in accord with policy provisions. If you wish to
                  add beneficiary information at a later time, or need to add
                  more, please contact the plan administrator at (800) 621-8981.
                  Note: The beneficiary for dependent Child(ren) coverage is the
                  Member.
                </Alert>
                          ...
                          <Stack spacing={3}>
                            ...
                            <Box>
                              ...
                              <Alert severity="info" sx={{ mb: 2 }}>
                                I make the following beneficiary designation
                                with respect to all life insurance under this
                                insurance plan and, if I am already covered
                                under the plan, I hereby revoke any prior
                            ...
                            <Box>
                              ...
                              <Alert severity="info" sx={{ mb: 2 }}>
                                I make the following beneficiary designation
                                with respect to new insurance issued on the
                                basis of this application. If you currently have
                                insurance and wish to change your beneficiary,
                                contact the Plan Administrator for the proper
                                form.
                              </Alert>
                            ...
                            <Stack spacing={3}>
                              ...
                              <Box>
                                ...
                                <Alert severity="info" sx={{ mb: 2 }}>
                                  I make the following beneficiary designation
                                  with respect to new insurance issued on the
                                  basis of this application. If you currently
                                  have insurance and wish to change your
                                  beneficiary, contact the Plan Administrator
                                  for the proper form.
                                </Alert>
          ...
          <Card sx={commonStyles.categoryCard}>
            <CardContent>
              <Stack spacing={2}>
                ...
                <Alert severity="info">
                  Please indicate how you would like to pay for this insurance.
                  You won't be billed until underwriting and review are approved
                  for coverage. We make sure your payment is secure. You may
                  find more details about your privacy and safety in the privacy
                  notice.
                </Alert>
                              ...
                              <Stack spacing={2}>
                                ...
                                <Box sx={{ mt: 3 }}>
                                  ...
                                  >
                                    ...
                                    American Bar Endowment Plan Administrator to
                                    make withdrawals against the account
                                    specified above or any other account
                                    subsequently identified by me, and each bank
                                    to process those withdrawals as if I had
                                    signed them, for the purpose of collecting
                                    premium contributions due under each
                                    insurance plan indicated as AutoPay(ETF) in
